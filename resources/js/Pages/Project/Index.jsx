                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase border-b-2 bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-gray-500">
                                ...
                                <tbody>
                                    {projects && projects.data && projects.data.map((project) => (
                                        <tr key={project.id} className="bg-white boder-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <Pagination Links={projects && projects.meta && projects.meta.links} />
                        </div>
                    </div>
                </div>
            </div>
